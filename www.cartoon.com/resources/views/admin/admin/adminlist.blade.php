...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> 
		<span class="l">
			...
			<a href="javascript:;" onclick="admin_add('添加管理员','{{ url('admin/adminadd') }}','800','500')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员
			</a>
		</span> 
	...
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td>{{ date('Y-m-d',$data->add_time) }}</td>
				@if($data->is_lock == 1)
				<td class="td-status"><span class="label label-success radius">已启用</span></td>
				@else
				<td class="td-status"><span class="label radius">未启用</span></td>
				@endif
				<td class="td-manage">
					<a style="text-decoration:none" onClick="admin_stop(this,'10001')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i>
					</a> 
					<a title="编辑" href="javascript:;" onclick="admin_edit('管理员编辑','{{ url("admin/adminedit") }}?admin_id='+{{ $data->admin_id }},'1','800','500')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i>
					</a> 
